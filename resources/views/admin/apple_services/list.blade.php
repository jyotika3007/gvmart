...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <form action="{{url('admin.apple_services.search_services')}}" method="get">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-3">
                    ...
                    <div class="col-sm-4">
                        ...
                        <a href="{{ route('admin.apple_services.index') }}" name="search" id="reset" vaule="reset" class="btn btn-warning">Reset</a>
                    </div>
                    <div class="col-sm-2">
                        <a href="{{ route('admin.apple_services.create') }}" class="btn btn-primary">Add New</a>
                    </div>
                </div>
            </form>
            <br>
            ...
            <table class="table table-bordered table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ date('M d, Y', strtotime(explode(' ',$service->created_at)[0])) }}</td>
                        <td>
                        ...
                        <td>@include('layouts.status', ['status' => $service->status])</td>
                        <td>
                            <form action="{{ route('admin.apple_services.destroy', $service->id) }}" method="post" class="form-horizontal">
                                {{ csrf_field() }}
                                <input type="hidden" name="_method" value="delete">
                                <div class="btn-group">
                                    <a href="{{ route('admin.apple_services.edit', $service->id) }}" class="btn btn-default btn-sm"><i class="fa fa-edit"></i></a>
