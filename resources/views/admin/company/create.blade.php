            ...
            <form action="{{ route('admin.company_detail.store') }}" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="contact" id="contact" placeholder="Contact Number" class="form-control" value="{{ old('contact') }}"  onkeypress="return isNumberKey(event)" maxlength="10">
